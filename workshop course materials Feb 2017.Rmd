...
The folder **JCU telemetry workshop** I have provided you with contains the course documents and the data we are going to be working with. This is organised in the same format that I organise all my project files, and I have found it completely transferable across all the projects I am involved with. The main project folder contains the following sub folders:
